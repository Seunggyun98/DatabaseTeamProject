...
public class Database {
    ...
    public void createTable(Connection conn) throws SQLException {
        ...
        statement.executeUpdate("DROP TABLE IF EXISTS path CASCADE;");
        ...
        statement.executeUpdate("create table if not exists path(ItemNumber varchar(20), bName varchar(20), sName varchar(40), locX double precision,locY double precision, distance double precision );");
    }
